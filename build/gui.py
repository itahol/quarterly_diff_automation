...
def save_diff_result():
    ...
    # with open("../new_investments.csv", "w", encoding="utf-8", newline="") as f:
    #     writer = DictWriter(f, fieldnames=[field.name for field in fields(CompanyInvestment)])
    #     writer.writeheader()
    #     # writer.writer.writerow("New investments")
    #     writer.writerows((asdict(investment) for investment in new_investments.values()))
    #     # writer.writer.writerow("")
    #     # writer.writer.writerow("Updated investments")
    #     writer.writerows((asdict(investment) for investment in updated_investments.values()))
    #     # writer.writer.writerow("")
    #     # writer.writer.writerow("Deprecated investments")
    #     writer.writerows((asdict(investment) for investment in deprecated_investments.values()))
